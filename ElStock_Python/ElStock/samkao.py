...
<<<<<<<< HEAD:ElStock_Python/ElStock/samkao.py
ticker_list = ['005930','035720'] #카카오, 삼성 주식 종목 코드

========
# ticker_list=['005930','035720']
>>>>>>>> main:ElStock_Python/ElStock/samKa.py
# print(ticker_list)
...
ticker_code ='035720' # kaka0 : '035720'
df = stock.get_market_ohlcv_by_date(fromdate="20220101", todate=today, ticker=ticker_code)
